    ...
    <div class="container mt-5">
        ...
        <form action="add.php" method="POST" onsubmit="return validarFormulario(event)">
            <div class="mb-3">
                ...
                <span class="text-danger"></span> <!-- Mensaje de error para nombre -->
            </div>

            <div class="mb-3">
                <label for="apellidos" class="form-label">Apellidos:</label>
                <input type="text" name="apellidos" id="apellidos" class="form-control">
                <span class="text-danger"></span> <!-- Mensaje de error para apellidos -->
            </div>

            <div class="mb-3">
                <label for="username" class="form-label">Username:</label>
                <input type="text" name="username" id="username" class="form-control">
                <span class="text-danger"></span> <!-- Mensaje de error para username -->
            </div>

            <div class="mb-3">
                <label for="password" class="form-label">Contraseña:</label>
                <input type="password" name="password" id="password" class="form-control">
                <span class="text-danger"></span> <!-- Mensaje de error para contraseña -->
            </div>
            ...
            <div class="mb-3">
                ...
                <span class="text-danger"></span> <!-- Mensaje de error para rol -->
            </div>
